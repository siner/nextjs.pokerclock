...
export default function PlayGame(params: { template: string }) {
      ...
      try {
        ...
        if (
          ...
          if (validationResult.isValid && validationResult.data) {
            ...
            // Calcular el nivel actual basado en el tiempo transcurrido
            const calculatedLevelIndex = calculateCurrentLevelIndex(
              currentGame.elapsed,
              currentGame.levels
            );
            setLevelIndex(calculatedLevelIndex);
            setCurrentLevel(currentGame.levels[calculatedLevelIndex]);
            setNextLevel(currentGame.levels[calculatedLevelIndex + 1]);
  ...
  }, [timer, levelIndex, levels, playing]);
        ...
        <CardContent className="p-5">
          <div className="text-center">
            ...
            <Button
              ...
              onClick={() => {
                // Calcular el tiempo total hasta el final del nivel actual
